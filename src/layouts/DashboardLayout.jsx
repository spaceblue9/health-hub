        ...
        <div className="p-md gap-sm flex flex-col border-t border-border-light">
          <div className="flex flex-col gap-2 mb-2 bg-surface-container-low p-2 rounded-2xl border border-border-light shadow-sm">
            ...
            <div className="flex items-center justify-between gap-1 bg-surface-container-high rounded-full p-1">
              <button onClick={() => setFontLevel(1)} className={`flex-1 flex items-center justify-center py-1.5 rounded-full transition-all ${fontLevel === 1 ? 'bg-surface shadow-sm text-primary font-bold scale-105' : 'text-text-muted hover:text-on-surface'}`} title="ขนาดปกติ">
                <span className="text-sm">A</span>
              </button>
              <button onClick={() => setFontLevel(2)} className={`flex-1 flex items-center justify-center py-1.5 rounded-full transition-all ${fontLevel === 2 ? 'bg-surface shadow-sm text-primary font-bold scale-105' : 'text-text-muted hover:text-on-surface'}`} title="ขนาดใหญ่">
                <span className="text-base">A</span>
              </button>
              <button onClick={() => setFontLevel(3)} className={`flex-1 flex items-center justify-center py-1.5 rounded-full transition-all ${fontLevel === 3 ? 'bg-surface shadow-sm text-primary font-bold scale-105' : 'text-text-muted hover:text-on-surface'}`} title="ขนาดใหญ่พิเศษ">
